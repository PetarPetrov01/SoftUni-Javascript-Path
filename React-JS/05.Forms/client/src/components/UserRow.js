...
export const UserRow = ({
    ...
    const { onControllersClick } = useContext(UserContext);
    ...
    return (
        <tr>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={(e) => onControllersClick(e, _id, 'Edit')} >
                ...
                <button className="btn delete-btn" title="Delete" onClick={(e) => onControllersClick(e, _id, 'Delete')}>
                ...
                <button className="btn info-btn" title="Info" onClick={(e) => onControllersClick(e, _id, 'Info')}>
